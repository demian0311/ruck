  ...
  <div class="dialog">
    <table>
      ...
      <tr class="prop">
        ...
        <td valign="top" class="value">${fieldValue(bean: authority, field: 'id')}</td>
      ...
      <tr class="prop">
        ...
        <td valign="top" class="value">${fieldValue(bean: authority, field: 'authority')}</td>
      ...
      <tr class="prop">
        ...
        <td valign="top" class="value">${fieldValue(bean: authority, field: 'description')}</td>
